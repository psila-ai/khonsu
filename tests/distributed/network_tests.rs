...
fn test_concurrent_writes_from_different_nodes() {
    ...
    manually_replicate_data(Arc::clone(khonsu1), Arc::clone(khonsu2), &[key1.clone(), key2.clone(), key3.clone()]);
    manually_replicate_data(Arc::clone(khonsu2), Arc::clone(khonsu1), &[key1.clone(), key2.clone(), key3.clone()]);
    manually_replicate_data(Arc::clone(khonsu3), Arc::clone(khonsu1), &[key1.clone(), key2.clone(), key3.clone()]);
    manually_replicate_data(Arc::clone(khonsu1), Arc::clone(khonsu3), &[key1.clone(), key2.clone(), key3.clone()]);
    manually_replicate_data(Arc::clone(khonsu2), Arc::clone(khonsu3), &[key1.clone(), key2.clone(), key3.clone()]);
    manually_replicate_data(Arc::clone(khonsu3), Arc::clone(khonsu2), &[key1.clone(), key2.clone(), key3.clone()]);
